...
except Exception:  # noqa: BLE001 — optional; only needed for get_text_model/embeddings
...
except Exception:  # noqa: BLE001 — optional fallback parser
    ConfigParser = None  # type: ignore[assignment,misc]
    PdfConverter = None  # type: ignore[assignment,misc]
    text_from_rendered = None  # type: ignore[assignment,misc]
...
try:
    ...
    AutoFeatureExtractor = None  # type: ignore[assignment,misc]
